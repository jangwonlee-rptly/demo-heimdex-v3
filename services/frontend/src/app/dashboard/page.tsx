  ...
  return (
    <div className="min-h-screen bg-surface-950 pt-20 pb-12">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* People Feature Card */}
        <div className="card mb-6 bg-gradient-to-br from-accent-cyan/5 to-accent-violet/5 border-accent-cyan/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-surface-100 font-semibold mb-1">{t.people.title}</h3>
                <p className="text-surface-400 text-sm">
                  Add face profiles to boost person-based search results
                </p>
              </div>
            </div>
            <button
              onClick={() => router.push('/people')}
              className="btn btn-ghost text-accent-cyan hover:bg-accent-cyan/10"
            >
